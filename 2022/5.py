...
def parse_data():
    ...
    return stack_structure, instructions

def solve_part_1():
    stack_structure, instructions = parse_data()
...
def solve_part_2():
    ...
    for instruction in instructions:
        ...
        moved_containers = stack_structure[i][:num]
        new_i = stack_structure[i][num:]
        new_j = [*moved_containers, *stack_structure[j]]
